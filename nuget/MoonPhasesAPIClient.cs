...
namespace APIVerve.API.MoonPhases
{
    ...
    /// <summary>
    /// Client for the MoonPhases API
    /// </summary>
    public class MoonPhasesAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/moonphases";
        ...
        {
            { "today", new ValidationRule { Type = "boolean", Required = false } }
        };
        ...
        public MoonPhasesAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public MoonPhasesAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public MoonPhasesAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, MoonPhasesQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(MoonPhasesQueryOptions options)
        {
        ...
        public ResponseObj Execute(MoonPhasesQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(MoonPhasesQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(MoonPhasesQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(MoonPhasesQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(MoonPhasesQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(MoonPhasesQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(MoonPhasesQueryOptions options)
        {
