...
const (
	baseURL        = "https://api.apiverve.com/v1/moonphases"
	defaultTimeout = 30 * time.Second
)

// Client is the Moon Phases API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Moon Phases API client.
...
// Execute makes a request to the Moon Phases API with typed parameters.
//
