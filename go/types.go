// Package moonphases provides a Go client for the Moon Phases API.
//
// For more information, visit: https://moonphases.apiverve.com?utm_source=go&utm_medium=readme
package moonphases
...
// Request contains the parameters for the Moon Phases API.
//
// Parameters:
//   - today: boolean - Get the moon phase for today
type Request struct {
	Today bool `json:"today,omitempty"` // Optional
}
...
// ResponseData contains the data returned by the Moon Phases API.
type ResponseData struct {
	Phase string `json:"phase"`
	PhaseEmoji string `json:"phaseEmoji"`
	Waxing bool `json:"waxing"`
	Waning bool `json:"waning"`
	LunarAge float64 `json:"lunarAge"`
	LunarAgePercent float64 `json:"lunarAgePercent"`
	LunationNumber int `json:"lunationNumber"`
	LunarDistance float64 `json:"lunarDistance"`
	NextFullMoon string `json:"nextFullMoon"`
	LastFullMoon string `json:"lastFullMoon"`
}
